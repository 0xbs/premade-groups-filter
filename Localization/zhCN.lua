...
L["settings.sortSignedUpToBottom.title"] = "将已申请钥匙排序到底部"
L["settings.sortSignedUpToBottom.tooltip"] = "将您已经申请过的队伍排序到列表底部，而不是顶部。"
L["settings.sortNewToTop.title"] = "新队伍排在顶部"
L["settings.sortNewToTop.tooltip"] = "将上次搜索后出现的新队伍（绿色名称）排在列表最上方。"
L["settings.sortDeclinedToBottom.title"] = "被拒绝队伍排在底部"
L["settings.sortDeclinedToBottom.tooltip"] = "将曾拒绝您的队伍（红色名称）排在较低位置，但仍高于没有适合您职责的队伍。"
L["settings.sortCanceledAtBottom.title"] = "已取消队伍排在底部"
L["settings.sortCanceledAtBottom.tooltip"] = "将您曾取消申请的队伍（粉色名称）排在较低位置，但仍高于没有适合您职责的队伍。"
L["settings.autoAcceptInvite.title"] = "自动接受队伍邀请"
L["settings.autoAcceptInvite.tooltip"] = "在您下次点击队伍列表时自动接受预组队邀请（需要硬件事件）。"
