...
L["settings.oneClickSignUp.title"] = "一键注册"
L["settings.oneClickSignUp.tooltip"] = "通过单击直接注册一个组，而不是先选择它，然后单击注册。"
L["settings.persistSignUpNote.title"] = "坚持注册记录"
L["settings.persistSignUpNote.tooltip"] = "在注册不同的组时坚持“组长注意事项”。 默认情况下，选择新组时会删除注释。"
L["settings.signupOnEnter.title"] = "使用回车键注册"
L["settings.signupOnEnter.tooltip"] = "注册新组时自动聚焦“组长注意事项”文本框，并按回车键确认您的申请。"
