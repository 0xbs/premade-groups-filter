...
L["message.noplaystylefix"] = "预创建队伍过滤: Will not apply fix for 'Interface action failed because of an AddOn' errors because you don't seem to have a fully secured account and otherwise can't create premade groups. See addon FAQ for more information and how to fix this issue."
...
L["settings.classNamesInTooltip.title"] = "工具提示中的类名"
L["settings.classNamesInTooltip.tooltip"] = "在预制组的工具提示中按角色显示类列表。"
L["settings.coloredGroupTexts.title"] = "彩色组名称和活动"
L["settings.coloredGroupTexts.tooltip"] = "如果群组是新的，则以绿色显示群组名称，如果您之前被拒绝，则以红色显示。 如果您对该实例进行了锁定，则以红色显示活动名称。"
L["settings.leaderCrown.title"] = "显示组长"
L["settings.leaderCrown.tooltip"] = "在预制地牢组列表中组长角色上方显示一个小皇冠。"
L["settings.ratingInfo.title"] = "组长评分"
L["settings.ratingInfo.tooltip"] = "在预制组列表中显示组长的 Mythic+ 或 PvP 等级。"
