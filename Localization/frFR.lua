...
L["dialog.expl.simple"] = "Choisir la catégorie et un min / max, puis rechercher !"
...
L["dialog.tooltip.title"] = "Filtres d'expressions avancée"
...
L["dialog.tooltip.defeated"] = "nombre de boss de raid vaincu"
...
L["dialog.tooltip.partyfit"] = "a des places pour les rôles de mon groupe"
L["dialog.tooltip.classes"] = "nombre de classe spécifique"
L["dialog.tooltip.age"] = "âge du groupe (en minute)"
L["dialog.tooltip.voice"] = "a une discussion audio"
...
L["dialog.tooltip.ex.parentheses"] = "(vocal ou non)"
L["dialog.tooltip.ex.not"] = "n'est pas sur mon royaume"
L["dialog.tooltip.ex.and"] = "héroïque et RdR"
L["dialog.tooltip.ex.or"] = "normal ou héroïque"
L["dialog.tooltip.ex.eq"] = "dps == 3"
L["dialog.tooltip.ex.neq"] = "membres ~= 0"
L["dialog.tooltip.ex.lt"] = "hlvl >= 5"
L["dialog.tooltip.ex.find"] = "not name:find(\"wts\")"
L["dialog.tooltip.ex.match"] = "name:match(\"+(%d)\")==\"5\""
L["dialog.copy.url.keywords"] = "Ctrl + Clic + C pour copier le lien vers la liste des mots-clés"
...
L["settings.classNamesInTooltip.title"] = "Noms de classe dans l'infobulle"
...
L["settings.signupOnEnter.tooltip"] = "Mettre automatiquement en évidence la zone de texte « note au chef du groupe » lorsque vous vous inscrivez à un nouveau groupe et confirmez votre demande en appuyant sur la touche Entrée."
