...
L["dialog.expl.simple"] = "Choisir une catégorie et définir le nombre de joueur souhaiter"
L["dialog.expl.state"] = "Nombre de joueur"
L["dialog.expl.min"] = "min"
L["dialog.expl.max"] = "max"
L["dialog.expl.advanced"] = "Si les options ci-dessus sont trop limitées, utilisez les requêtes avancées."
...
L["dialog.tooltip.members"] = "nombre de membre"
L["dialog.tooltip.tanks"] = "nombre de tank"
L["dialog.tooltip.heals"] = "nombre de soigneur"
L["dialog.tooltip.dps"] = "nombre de DPS"
L["dialog.tooltip.partyfit"] = "«y a-t-il des places pour les « rôles » de mon groupe"
L["dialog.tooltip.classes"] = "nombre de classe spécifique"
...
L["dialog.tooltip.matchingid"] = "même boss tué que mon groupe"
...
L["settings.classNamesInTooltip.title"] = "Nom de classe dans l'infobulle"
...
L["settings.classBar.title"] = "Barre en couleur de classe" -- à revoir
L["settings.classBar.tooltip"] = "Affiche une petite barre de couleur de classe sous chaque rôle." -- à revoir
L["settings.classCircle.title"] = "Cercle en couleur de classe" -- à revoir
L["settings.classCircle.tooltip"] = "Affiche un cercle de couleur de classe à l'arrière-plan de chaque rôle." -- à revoir
L["settings.leaderCrown.title"] = "Afficher chef de groupe" -- à revoir
L["settings.leaderCrown.tooltip"] = "Affiche une petite couronne au-dessus du rôle du chef de groupe" -- à revoir
