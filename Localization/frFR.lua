...
L["settings.refreshBeforeSelect.title"] = "Actualiser avant la sélection"
L["settings.refreshBeforeSelect.tooltip"] = "Actualise automatiquement la liste des groupes avant d’en sélectionner un lors de l’inscription en un clic. Utile avec le tri des clés inscrites en bas pour garder les nouveaux groupes en haut."
