...
L["settings.classCircle.tooltip"] = "Affiche un cercle de couleur en arrière-plan de chaque rôle."
...
L["settings.signupOnEnter.tooltip"] = "Activez automatiquement la zone de texte « Note au chef de groupe » lors de votre inscription à un nouveau groupe et confirmez votre candidature en appuyant sur Entrée."
...
L["settings.coloredApplications.tooltip"] = "Affiche un fond rouge pour les candidatures en attente uniquement si le groupe n’a plus de place pour votre rôle."
