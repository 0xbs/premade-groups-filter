...
L["settings.sortSignedUpToBottom.title"] = "Trier les clés inscrites en bas"
L["settings.sortSignedUpToBottom.tooltip"] = "Place les groupes auxquels vous êtes déjà inscrit en bas de la liste au lieu du haut."
L["settings.sortNewToTop.title"] = "Trier les nouveaux groupes en haut"
L["settings.sortNewToTop.tooltip"] = "Place les groupes nouveaux depuis la dernière recherche (nom vert) tout en haut de la liste."
L["settings.sortDeclinedToBottom.title"] = "Trier les groupes refusés en bas"
L["settings.sortDeclinedToBottom.tooltip"] = "Place les groupes qui vous ont précédemment refusé (nom rouge) vers le bas, mais encore au-dessus des groupes sans rôle pour vous."
L["settings.sortCanceledAtBottom.title"] = "Trier les groupes annulés en bas"
L["settings.sortCanceledAtBottom.tooltip"] = "Place les groupes pour lesquels vous avez annulé votre candidature (nom rose) vers le bas, mais encore au-dessus des groupes sans rôle pour vous."
L["settings.autoAcceptInvite.title"] = "Accepter les invitations automatiquement"
L["settings.autoAcceptInvite.tooltip"] = "Accepte automatiquement les invitations de groupes prédéfinis lors du prochain clic sur la liste des groupes (nécessite un événement matériel)."
