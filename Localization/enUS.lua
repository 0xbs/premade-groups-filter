...
L["settings.sortSignedUpToBottom.title"] = "Sort Signed Up Keys to Bottom"
L["settings.sortSignedUpToBottom.tooltip"] = "Sort groups you have already signed up for to the bottom of the list instead of the top."
L["settings.sortNewToTop.title"] = "Sort New Groups to Top"
L["settings.sortNewToTop.tooltip"] = "Sort groups that are new since the last search (green name) to the very top of the list."
L["settings.sortDeclinedToBottom.title"] = "Sort Declined Groups to Bottom"
L["settings.sortDeclinedToBottom.tooltip"] = "Sort groups that previously declined you (red name) toward the bottom, but still above groups without a role for you."
L["settings.sortCanceledAtBottom.title"] = "Sort Canceled Groups to Bottom"
L["settings.sortCanceledAtBottom.tooltip"] = "Sort groups you previously canceled your application for (pink name) toward the bottom, but still above groups without a role for you."
L["settings.autoAcceptInvite.title"] = "Auto Accept Group Invites"
L["settings.autoAcceptInvite.tooltip"] = "Automatically accepts premade group invites on your next click on the group list (requires a hardware event)."
