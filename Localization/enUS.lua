...
L["settings.applyDeclined.title"] = "Apply to declined groups"
L["settings.applyDeclined.tooltip"] = "Restore the old behavior before TWW and allow to sign up to groups that previously declined you."
