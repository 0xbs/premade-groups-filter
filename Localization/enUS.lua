...
L["settings.refreshBeforeSelect.title"] = "Refresh Before Select"
L["settings.refreshBeforeSelect.tooltip"] = "Automatically refreshes the group list before selecting a group when using One Click Sign Up. Useful together with sorting signed-up groups to the bottom so new groups stay at the top."
