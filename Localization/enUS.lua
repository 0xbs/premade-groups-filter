...
L["settings.alwaysShowMembers.title"] = "Always Show Members"
L["settings.alwaysShowMembers.tooltip"] = "Keeps the list of party members visible even if  in the premade group list."
