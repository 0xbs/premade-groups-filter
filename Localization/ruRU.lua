...
L["settings.refreshBeforeSelect.title"] = "Обновлять перед выбором"
L["settings.refreshBeforeSelect.tooltip"] = "Автоматически обновляет список групп перед выбором группы при присоединении в один клик. Полезно вместе с сортировкой заявленных ключей вниз, чтобы новые группы оставались сверху."
