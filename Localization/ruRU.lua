...
L["settings.persistSignUpNote.tooltip"] = "Сохраняет «заметку лидеру группы» при подписке на разные группы. По умолчанию заметка удаляется при выборе новой группы."
