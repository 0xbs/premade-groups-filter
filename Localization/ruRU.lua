...
L["settings.oneClickSignUp.tooltip"] = "Подпишитесь в группу напрямую, нажав на нее, а не просто выбрав ее."
L["settings.persistSignUpNote.title"] = "Сохранить примечание о регистрации"
L["settings.persistSignUpNote.tooltip"] = "Сохраняет «примечание лидеру группы» при регистрации в разных группах. По умолчанию заметка удаляется при выборе новой группы."
L["settings.signupOnEnter.title"] = "Войти с помощью Enter"
L["settings.signupOnEnter.tooltip"] = "Автоматически фокусируйте текстовое поле «Примечание руководителю группы» при регистрации в новой группе и подтвердите свою заявку, нажав клавишу ввода."
