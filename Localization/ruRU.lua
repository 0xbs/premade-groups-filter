...
L["settings.classCircle.title"] = "Кружок в цвете класса"
L["settings.classCircle.tooltip"] = "Показывает круг в цвете класса на фоне каждой роли в списке готовых групп подземелий."
