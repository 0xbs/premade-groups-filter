...
L["settings.sortSignedUpToBottom.title"] = "Сортировать заявленные ключи вниз"
L["settings.sortSignedUpToBottom.tooltip"] = "Сортирует группы, в которые вы уже подали заявку, в конец списка вместо начала."
L["settings.sortNewToTop.title"] = "Новые группы вверх"
L["settings.sortNewToTop.tooltip"] = "Сортирует группы, появившиеся с прошлого поиска (зелёное имя), в самый верх списка."
L["settings.sortDeclinedToBottom.title"] = "Отклонённые группы вниз"
L["settings.sortDeclinedToBottom.tooltip"] = "Сортирует группы, которые ранее отклонили вас (красное имя), ближе к низу, но выше групп без подходящей для вас роли."
L["settings.sortCanceledAtBottom.title"] = "Отменённые группы вниз"
L["settings.sortCanceledAtBottom.tooltip"] = "Сортирует группы, для которых вы отменили заявку (розовое имя), ближе к низу, но выше групп без подходящей для вас роли."
L["settings.autoAcceptInvite.title"] = "Автоматически принимать приглашения"
L["settings.autoAcceptInvite.tooltip"] = "Автоматически принимает приглашения при следующем клике по списку групп (требуется аппаратное событие)."
