...
L["settings.refreshBeforeSelect.title"] = "Actualizar antes de seleccionar"
L["settings.refreshBeforeSelect.tooltip"] = "Actualiza automáticamente la lista de grupos antes de seleccionar un grupo al usar Registrarse en un clic. Útil junto con ordenar claves inscritas al final para que los grupos nuevos sigan arriba."
