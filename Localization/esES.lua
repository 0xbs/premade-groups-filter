...
L["settings.sortSignedUpToBottom.title"] = "Ordenar claves inscritas al final"
L["settings.sortSignedUpToBottom.tooltip"] = "Ordena los grupos a los que ya te has inscrito al final de la lista en lugar de al principio."
L["settings.sortNewToTop.title"] = "Ordenar grupos nuevos arriba"
L["settings.sortNewToTop.tooltip"] = "Ordena los grupos nuevos desde la última búsqueda (nombre verde) en la parte superior de la lista."
L["settings.sortDeclinedToBottom.title"] = "Ordenar grupos rechazados al final"
L["settings.sortDeclinedToBottom.tooltip"] = "Ordena los grupos que te rechazaron anteriormente (nombre rojo) hacia abajo, pero aún por encima de grupos sin rol para ti."
L["settings.sortCanceledAtBottom.title"] = "Ordenar grupos cancelados al final"
L["settings.sortCanceledAtBottom.tooltip"] = "Ordena los grupos en los que cancelaste tu solicitud (nombre rosa) hacia abajo, pero aún por encima de grupos sin rol para ti."
L["settings.autoAcceptInvite.title"] = "Aceptar invitaciones automáticamente"
L["settings.autoAcceptInvite.tooltip"] = "Acepta automáticamente las invitaciones a grupos prefabricados con el siguiente clic en la lista de grupos (requiere un evento de hardware)."
