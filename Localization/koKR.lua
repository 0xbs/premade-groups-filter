...
L["settings.sortSignedUpToBottom.title"] = "가입한 쐐기돌을 목록 하단으로 정렬"
L["settings.sortSignedUpToBottom.tooltip"] = "이미 가입한 그룹을 목록 상단이 아닌 하단에 정렬합니다."
L["settings.sortNewToTop.title"] = "새 그룹을 상단으로 정렬"
L["settings.sortNewToTop.tooltip"] = "마지막 검색 이후 새로 나타난 그룹(녹색 이름)을 목록 맨 위에 정렬합니다."
L["settings.sortDeclinedToBottom.title"] = "거부된 그룹을 하단으로 정렬"
L["settings.sortDeclinedToBottom.tooltip"] = "이전에 거부한 그룹(빨간색 이름)을 아래쪽에 정렬하되, 내 역할이 없는 그룹보다는 위에 둡니다."
L["settings.sortCanceledAtBottom.title"] = "취소한 그룹을 하단으로 정렬"
L["settings.sortCanceledAtBottom.tooltip"] = "이전에 지원을 취소한 그룹(분홍색 이름)을 아래쪽에 정렬하되, 내 역할이 없는 그룹보다는 위에 둡니다."
L["settings.autoAcceptInvite.title"] = "그룹 초대 자동 수락"
L["settings.autoAcceptInvite.tooltip"] = "다음 그룹 목록 클릭 시 미리 만들어진 그룹 초대를 자동으로 수락합니다(하드웨어 이벤트 필요)."
