...
L["settings.signUpDeclined.warning"] = "이 옵션은 레이드나 전투 중과 같은 제한된 상황에서 Lua 오류를 발생시킬 수 있습니다."
...
L["dialog.taint.text"] = "애드온 제한이 현재 활성화되어 있습니다. Premade Groups Filter가 파티 찾기를 수정하여 제한이 활성화된 동안 Lua 오류가 발생할 수 있습니다. 이를 해결하려면 /reload를 권장합니다."
L["dialog.taint.reload"] = "UI 새로고침"
