...
L["settings.refreshBeforeSelect.title"] = "선택 전 새로고침"
L["settings.refreshBeforeSelect.tooltip"] = "원 클릭 가입 시 그룹을 선택하기 전에 그룹 목록을 자동으로 새로고침합니다. 가입한 쐐기돌을 목록 하단으로 정렬할 때 새 그룹이 위에 남도록 하는 데 유용합니다."
