...
L["settings.refreshBeforeSelect.title"] = "Aggiorna prima della selezione"
L["settings.refreshBeforeSelect.tooltip"] = "Aggiorna automaticamente l’elenco dei gruppi prima di selezionarne uno con Iscriviti con un clic. Utile insieme all’ordinamento delle chiavi iscritte in fondo per tenere i nuovi gruppi in alto."
