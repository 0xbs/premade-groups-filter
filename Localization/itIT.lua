...
L["settings.sortSignedUpToBottom.title"] = "Ordina chiavi iscritte in fondo"
L["settings.sortSignedUpToBottom.tooltip"] = "Ordina i gruppi a cui ti sei già iscritto in fondo all'elenco invece che in cima."
L["settings.sortNewToTop.title"] = "Ordina nuovi gruppi in alto"
L["settings.sortNewToTop.tooltip"] = "Ordina i gruppi nuovi dall'ultima ricerca (nome verde) in cima all'elenco."
L["settings.sortDeclinedToBottom.title"] = "Ordina gruppi rifiutati in fondo"
L["settings.sortDeclinedToBottom.tooltip"] = "Ordina i gruppi che ti hanno rifiutato in precedenza (nome rosso) verso il basso, ma ancora sopra i gruppi senza un ruolo per te."
L["settings.sortCanceledAtBottom.title"] = "Ordina gruppi annullati in fondo"
L["settings.sortCanceledAtBottom.tooltip"] = "Ordina i gruppi per cui hai annullato la candidatura (nome rosa) verso il basso, ma ancora sopra i gruppi senza un ruolo per te."
L["settings.autoAcceptInvite.title"] = "Accetta inviti automaticamente"
L["settings.autoAcceptInvite.tooltip"] = "Accetta automaticamente gli inviti ai gruppi premade al prossimo clic sull’elenco dei gruppi (richiede un evento hardware)."
