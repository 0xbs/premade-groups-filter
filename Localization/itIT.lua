...
L["dialog.taint.text"] = "Premade Groups Filter ha modificato il cercatore di gruppi, il che potrebbe causare errori Lua durante il raid. Si consiglia un /reload per risolvere il problema."
