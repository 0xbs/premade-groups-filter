...
L["settings.oneClickSignUp.title"] = "一鍵註冊"
L["settings.oneClickSignUp.tooltip"] = "通過單擊直接註冊一個組，而不是先選擇它，然後單擊註冊。"
L["settings.persistSignUpNote.title"] = "堅持註冊記錄"
L["settings.persistSignUpNote.tooltip"] = "在註冊不同的組時堅持“組長注意事項”。 默認情況下，選擇新組時會刪除註釋。"
L["settings.signupOnEnter.title"] = "使用回車鍵註冊"
L["settings.signupOnEnter.tooltip"] = "註冊新組時自動聚焦“組長注意事項”文本框，並按回車鍵確認您的申請。"
