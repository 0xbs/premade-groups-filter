...
L["dialog.tooltip.ex.parentheses"] = "（語音或非語音）"
L["dialog.tooltip.ex.not"] = "非我伺服器"
L["dialog.tooltip.ex.and"] = "heroic and hfc"
L["dialog.tooltip.ex.or"] = "普通 或 英雄"
L["dialog.tooltip.ex.eq"] = "dps == 3"
L["dialog.tooltip.ex.neq"] = "成員 ~= 0"
...
L["settings.skipSignUpDialog.title"] = "跳過註冊對話框"
L["settings.skipSignUpDialog.tooltip"] = "如果可能，跳過角色/註釋提示並立即註冊到該組。 按住 shift 以始終顯示對話框。"
