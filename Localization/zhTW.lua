...
L["settings.sortSignedUpToBottom.title"] = "將已報名鑰石排序到底部"
L["settings.sortSignedUpToBottom.tooltip"] = "將您已經報名的隊伍排序到列表底部，而不是頂部。"
L["settings.sortNewToTop.title"] = "新隊伍排在頂部"
L["settings.sortNewToTop.tooltip"] = "將上次搜尋後出現的新隊伍（綠色名稱）排在列表最上方。"
L["settings.sortDeclinedToBottom.title"] = "被拒絕隊伍排在底部"
L["settings.sortDeclinedToBottom.tooltip"] = "將曾拒絕您的隊伍（紅色名稱）排在較低位置，但仍高於沒有適合您職責的隊伍。"
L["settings.sortCanceledAtBottom.title"] = "已取消隊伍排在底部"
L["settings.sortCanceledAtBottom.tooltip"] = "將您曾取消申請的隊伍（粉色名稱）排在較低位置，但仍高於沒有適合您職責的隊伍。"
L["settings.autoAcceptInvite.title"] = "自動接受隊伍邀請"
L["settings.autoAcceptInvite.tooltip"] = "在您下次點擊隊伍列表時自動接受預組隊伍邀請（需要硬體事件）。"
