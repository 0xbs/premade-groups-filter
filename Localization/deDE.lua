...
L["settings.persistSignUpNote.tooltip"] = "Behält den „Hinweis an den Gruppenleiter“ bei der Anmeldung bei verschiedenen Gruppen bei. Standardmäßig wird die Notiz gelöscht, wenn eine neue Gruppe ausgewählt wird."
