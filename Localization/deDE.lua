...
L["settings.signUpDeclined.warning"] = "Diese Option kann in eingeschränkten Situationen wie Raids oder im Kampf zu Lua-Fehlermeldungen führen."
...
L["settings.reload.info"] = "* Änderungen an diesen Optionen führen beim Schließen der Einstellungen automatisch zu einem UI-Reload."
