...
L["settings.refreshBeforeSelect.title"] = "Vor Auswahl aktualisieren"
L["settings.refreshBeforeSelect.tooltip"] = "Aktualisiert die Gruppenliste automatisch, bevor eine Gruppe bei Ein-Klick Anmelden ausgewählt wird. Nützlich zusammen mit „Angemeldete Gruppen unten“, damit neue Gruppen oben bleiben."
