...
L["dialog.blfit"] = "KR Fit"
L["dialog.blfit.tooltip"] = "Wenn in eurer Gruppe niemand Kampfrausch/Heldentum zur Verfügung stellt, zeige nur Gruppen in denen bereits eine Klasse mit Kampfrausch/Heldentum vorhanden ist oder in denen nach Beitritt noch ein DPS-Platz frei ist. Funktioniert auch allein."
L["dialog.brfit"] = "BR Fit"
