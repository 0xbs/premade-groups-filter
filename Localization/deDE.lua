...
L["settings.sortSignedUpToBottom.title"] = "Angemeldete Gruppen unten"
L["settings.sortSignedUpToBottom.tooltip"] = "Sortiert Gruppen, für die Ihr euch bereits angemeldet habt, ans Ende der Liste statt an den Anfang."
L["settings.sortNewToTop.title"] = "Neue Gruppen nach oben"
L["settings.sortNewToTop.tooltip"] = "Sortiert Gruppen, die seit der letzten Suche neu sind (grüner Name), ganz nach oben in der Liste."
L["settings.sortDeclinedToBottom.title"] = "Abgelehnte Gruppen nach unten"
L["settings.sortDeclinedToBottom.tooltip"] = "Sortiert Gruppen, die euch zuvor abgelehnt haben (roter Name), nach unten, aber noch über Gruppen ohne passende Rolle für euch."
L["settings.sortCanceledAtBottom.title"] = "Abgebrochene Gruppen nach unten"
L["settings.sortCanceledAtBottom.tooltip"] = "Sortiert Gruppen, für die Ihr die Anmeldung abgebrochen habt (rosa Name), nach unten, aber noch über Gruppen ohne passende Rolle für euch."
L["settings.autoAcceptInvite.title"] = "Gruppeneinladungen automatisch annehmen"
L["settings.autoAcceptInvite.tooltip"] = "Nimmt Einladungen zu organisierten Gruppen automatisch mit dem nächsten Klick auf die Gruppenliste an (erfordert ein Hardware-Ereignis)."
