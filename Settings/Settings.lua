...
local PGFSettingsTable = {
    ...
    },
    {
        key = "sortNewToTop",
        type = "checkbox",
        title = L["settings.sortNewToTop.title"],
        tooltip = L["settings.sortNewToTop.tooltip"],
        visible = PGF.IsRetail(),
    },
    {
        key = "sortDeclinedToBottom",
        type = "checkbox",
        title = L["settings.sortDeclinedToBottom.title"],
        tooltip = L["settings.sortDeclinedToBottom.tooltip"],
        visible = PGF.IsRetail(),
    },
    {
        key = "sortCanceledAtBottom",
        type = "checkbox",
        title = L["settings.sortCanceledAtBottom.title"],
        tooltip = L["settings.sortCanceledAtBottom.tooltip"],
        visible = PGF.IsRetail(),
    },
    {
